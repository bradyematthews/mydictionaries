...
for school in schools:
    if school["NCAA"]["NAIA conference number football (IC2020)"] in conference_schools: #If the school number is listed in the numbers located in conference_number above, it moves on
